...
description: "Use before any web search or multi-step research task. Enforces plan-before-search: decompose the question, list hypotheses, design search paths, evaluate evidence, iterate if insufficient. Prevents blind searching and shallow answers."
---
