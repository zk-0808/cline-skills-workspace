...
- 归档旧 plan：在 `docs/plans/2026-06-18-context-and-memory-mvp.md` 顶部加 superseded 提示
...
- [ ] `LEARNINGS.md`（追加复盘条目）
- [ ] `docs/plans/2026-06-18-context-and-memory-mvp.md`（顶部加 superseded 提示）
...
4. `read_file docs/plans/2026-06-18-handoff-protocol-phase-2.md`（即本文）
5. 按 §2 顺序逐 Step 执行
